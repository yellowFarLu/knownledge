...
<img src="https://tva1.sinaimg.cn/large/00831rSTgy1gcmf34arbvj30pu0ce41b.jpg" alt="image-20200308124100957" style="zoom:67%;" />
...
![image-20200308124417328](https://tva1.sinaimg.cn/large/00831rSTgy1gcmf6j0i3mj312u07adhz.jpg)

![image-20200308124450512](https://tva1.sinaimg.cn/large/00831rSTgy1gcmf73p8irj30uo0eegpq.jpg)
...
![image-20200308124529080](https://tva1.sinaimg.cn/large/00831rSTgy1gcmf7rvupvj312s05ggna.jpg)

![image-20200308124542656](https://tva1.sinaimg.cn/large/00831rSTgy1gcmf80bc2jj30ss0dywin.jpg)

我们前面也提到，数据是动态变化的，当新添加一个数据的时候，我们如何调整两个堆，让大顶堆中的堆顶元素继续是中位数呢？

**如果新加入的数据小于等于大顶堆的堆顶元素，我们就将这个新数据插入到大顶堆；否则，我们就将这个新数据插入到小顶堆。**

![image-20200308124655900](https://tva1.sinaimg.cn/large/00831rSTgy1gcmf99uklhj312o070mz3.jpg)

![image-20200308124713330](https://tva1.sinaimg.cn/large/00831rSTgy1gcmf9l0jvkj30t60j8tfa.jpg)
...
![image-20200308124913165](https://tva1.sinaimg.cn/large/00831rSTgy1gcmfbnxprfj30o2078gnm.jpg)
...
然后，我们再根据前面讲的用堆求 Top K 的方法，建立一个大小为 10 的**小顶堆**，遍历散列表，依次取出每个搜索关键词及对应出现的次数，然后与堆顶的搜索关键词对比。如果出现次数比堆顶搜索关键词的次数多，那就删除堆顶的关键词，将这个出现次数更多的关键词加入到堆中。
